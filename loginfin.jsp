...
<html lang="en">
	...
	<title>login</title>
	<link rel="stylesheet" href="css/loginfin.css" >
 ...
 <nav class="row"> 
  <div id="nav">
	...
	<div class="container">
			...
			<div class="col-md-12"><h5>Congratulations ! <br>you are log in sucessfully !</h5></div>	
			<div class="col-md-12"><hr></div>
			<div class="col-md-12"><br></div>
			<div class="col-md-12" align="center"><a href="index.jsp"><input type="button" id="but" name="Ok" value="ok" class="button"></div>
		    <div class="col-md-12"><br></div>
		    <div class="col-md-12"><br></div>
