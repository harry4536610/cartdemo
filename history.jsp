  ...
  <div id="nav">
	...
	<div class="container">
		...
		<div class="row">	
			...
			<div class="col-md-12" align="center"><img src="img/invoice.png" class="icon"></div>
			<div class="col-md-12"><h5>History</h5></div>	
			<div class="col-md-12"><br></div>
		</div>	
	    ...
	    <content class="row" style="overflow:auto;">
	    	...
	    	sql="use store";
           		con.createStatement().execute(sql);
           	sql = "SELECT * from buyhistory where memberaccount='"+orderaccount+"'";
	       ...
	       <table class=" col-md-10 table table-hover" style="width:90%">
				...
				{String price = rs.getString(3);
                    ...
                    String buynumber = rs.getString(4);
