  ...
  <div id="nav">
	...
	<div class="container">
		...
		<div class="row">	
			...
			<div class="col-md-12" align="center"><img src="icon/member.png" class="icon"></div>
			<div class="col-md-12"><h5>Member Center</h5></div>	
			<div class="col-md-12"><br></div>
		</div>	
	    ...
	    <content class="row">
	        ...
	        <form  class="col-md-7"action="#" method="get" accept-charset="utf-8" >
	        	<p>
	        		<h2><opt>Hi，<%=rs2.getString("name")%>！</opt></h2> 
