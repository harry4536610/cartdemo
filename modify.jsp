  ...
  <div id="nav">
	...
	<div class="container">
		...
		<div class="row">	
			...
			<div class="col-md-12" align="center"><img src="img/edit.png" class="icon"></div>
			<div class="col-md-12"><h5>modify</h5></div>	
			<div class="col-md-12"><br></div>
		</div>	
		...
		<main class="row">	   
				...
				<div class="col-md-4">
			        <a href="modify.jsp"><img src="img/modify.png" class="process"></a>
			    
			      <a href="history.jsp"><img src="img/history.png" class="process"></a></div>
		</main>
		<!-- /main -->
        <!-- content -->
	    <content class="row">
	    	<div class="col-md-1"></div>
	    	    <form  class="col-md-8" action="modifyupdate.jsp" method="post" accept-charset="utf-8">
	        	<table>
		 				<tr>
		 					<td style="width:30%">
		 						<h2>Name</h2>
		 					...
		 					<td style="width:70%">
		 						<opt><input type="text" name="name" size="10" id="text" required></opt>
		 					</td>
		 				</tr>
		 				<tr>
		 					<td style="width:30%">
		 					...
		 					<td style="width:70%">
		 						<h2><input type="radio" name="gender" value="男" id="opt" checked/ required>Boy<input type="radio" name="gender" id="opt" value="女"/ required>Girl</h2>
		 					</td>
		 				</tr>
		 				<tr>
		 					<td style="width:30%">
		 					...
		 					<td style="width:70%">
		 						<input type="password" name="password" size="12" placeholder="bbb567" maxlength="8" id="text" required>
		 					</td>
		 				</tr>
		 				<tr>
		 					<td style="width:30%">
		 					...
		 					<td style="width:70%">
		 						<opt><input type="password" name="password2" size="10" maxlength="8" placeholder="max:8" id="text" required></opt>
		 					</td>
		 				</tr>
		 				<tr>
		 					<td style="width:30%">
						    ...
						    <td style="width:70%">
						    	<opt><input type="date" name="birth" size="10" id="text" required></opt>
						    </td>
		 				</tr>
		 				<tr>
		 				    <td style="width:30%">
		 					...
		 					<td style="width:70%"> 
		 						<opt><input type="phone" name="phone" maxlength="10" placeholder="09xxxxxxxx" id="text" required></opt>
		 					</td>
		 				</tr>
		 				<tr>
		 				    <td style="width:30%">
		 					...
		 					<td style="width:70%"> 
		 						<opt><input type="email" name="email"  placeholder="123@mail" id="text" required></opt>
		 					</td>
		 				</tr>
		 				<tr>
		 					<td style="width:30%">
		 					...
		 					<td>&nbsp;&nbsp;&nbsp;
		 						<opt>
		 							<select size="1" name="address" id="addr">
		 								<option>宜蘭縣</option>
		 								<option>基隆市</option>
		 								<option>新北市</option>
		 								<option>台北市</option>
	        		                ...
	        		                <input type="text" name="address2" size="25" id="add" required>
	        		            </opt>
	        		        </td>
	        		        <hr>
	        		    <tr>
	        		    ...
	        		    <tr>
	        		        ...
	        		        <td style="width:70%">
	        		        	<input type="submit" name="modify" value="modify" class="button">
	        		        </td>
	        		    </tr>
