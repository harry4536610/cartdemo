  ...
  <div id="nav">
	...
	<div class="container">
		...
		<content class="row" style="overflow:auto;" >
                    	...
                    	<tr>
                          ...
                          String no = rs.getString(1);
                    			...
                    			<th scope="row"><h3>#</h3></th>
									<td class="pic"><h3 class="move">
									<form name="delete" method="post" action="deletecart.jsp">
									<%out.print("<input type='hidden' name='deleteno' value='"+rs.getString(1)+"';>");%>
									<%out.print("<input type='hidden' name='deleteuser' value='"+rs.getString(19)+"';>");%>							
									<button type="submit"><img src="icon/trash.png" class="icon"></button>
									</form>
									</h3></td>
									<td style="width:180px"><div class="image"><img  src="<%=rs.getString(10)%>/<%=rs.getString(12)%>" width="155" height="160"></div></td>
									<td><h3><%out.print(name);%></h3></td>
									<td><h3>$<%out.print(price);%></h3></td>
            ...
            <div class="col-md-1"></div>
            <form name="send" method="post" action="pay.jsp">		
			<input type="submit" name="submit" value="pay"  class="cart" />
			</form>
		</content>
		<!-- /content -->
	</div>
